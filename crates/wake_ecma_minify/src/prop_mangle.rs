...
use wake_ecma_ast::{
    Expression, MemberProperty, ObjectMember, Program, PropertyKey, PropertyKind,
...
const RESERVED_PROPS: &[&str] = &[
    "length", "prototype", "name", "constructor",
    ...
    "this", "super", "new", "target", "default", "export",
    "now", "UTC", "parse", "stringify",
    ...
    "sqrt", "tan", "tanh", "trunc",
    "isArray", "isFinite", "isInteger", "isNaN", "isSafeInteger",
    "isFrozen", "isExtensible", "isSealed",
    "keys", "values", "entries", "freeze", "seal", "assign", "create",
    "defineProperty", "defineProperties", "getPrototypeOf", "setPrototypeOf",
    "getOwnPropertyDescriptor", "getOwnPropertyDescriptors",
    "getOwnPropertyNames", "getOwnPropertySymbols",
    "fromCharCode", "fromCodePoint", "raw",
    "charAt", "charCodeAt", "codePointAt", "concat", "endsWith",
    "includes", "indexOf", "lastIndexOf", "localeCompare",
    ...
    "findIndex", "findLast", "findLastIndex", "every", "some",
    "flat", "flatMap", "from", "of",
    "sort", "push", "pop", "shift", "unshift", "splice", "reverse",
    "fill", "copyWithin", "toReversed", "toSorted", "toSpliced", "with",
    "at", "join", "toString", "toLocaleString", "entries", "keys", "values",
    "indexOf", "lastIndexOf", "includes",
    "getItem", "setItem", "removeItem", "clear",
    "__reg", "__side",
    // React / JSX specific
    "createElement", "createRef", "Fragment", "cloneElement",
    "isValidElement", "useState", "useEffect", "useMemo", "useCallback",
    "useRef", "useReducer", "useContext",
    // Common DOM properties
    "innerHTML", "innerText", "textContent", "value", "checked",
    "disabled", "hidden", "style", "className", "classList",
    "id", "type", "name", "placeholder", "title", "alt", "src", "href",
    "onClick", "onChange", "onSubmit", "onFocus", "onBlur", "onKeyDown",
    "onKeyUp", "onMouseEnter", "onMouseLeave",
    "preventDefault", "stopPropagation",
    "children", "key", "ref",
    // Data / fetch
    "then", "catch", "finally",
    "status", "statusText", "ok", "headers", "json", "text", "blob", "arrayBuffer",
    "data", "error", "loading",
];

const GLOBALS: &[&str] = &[
    "Math", "Date", "JSON", "console", "Object", "Array", "String",
    "Number", "Boolean", "Symbol", "BigInt", "RegExp", "Map", "Set",
    "WeakMap", "WeakSet", "Promise", "Proxy", "Reflect",
    "Intl", "Buffer", "process", "global", "globalThis",
    "window", "document", "location", "history", "navigator",
    "localStorage", "sessionStorage",
    "setTimeout", "setInterval", "clearTimeout", "clearInterval",
    "fetch", "Worker", "WebSocket",
...
pub fn plan_prop_mangle(program: &Program, interner: &Interner) -> PropManglePlan {
    ...
    PropManglePlan { renames: name_to_short, span_renames }
}
    ...
    fn is_member_of_global(&self, obj: &Expression<'a>) -> bool {
        match obj {
            ...
            Expression::Member(m) if !m.optional => {
                self.is_member_of_global(&m.object)
            }
            _ => false,
        }
    }
