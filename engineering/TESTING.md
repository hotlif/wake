...
发布证据和 stable readiness：Windows x64 对 reviewed major 151 或 152、Linux x64 对 reviewed major 151 或 152 运行 blocking conformance；
...
- Windows x64 执行 reviewed major 151 或 152、Linux x64 执行 reviewed major 151 或 152 的显式 browser path、CDP lifecycle、React、
...
5. 发布前在五个目标平台和 Node 22.14/24/26 的 15 个组合中，以本次构建的主包、CSS 包和 matching
   ...
   Windows x64 的 reviewed major 151 或 152、Linux x64 的 reviewed major 151 或 152 执行 blocking conformance；在 macOS x64 上以 reviewed major 150 或 151、macOS arm64
